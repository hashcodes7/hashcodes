...
const PROJECTS_DETAILS = [
  ...
  },
  {
    ...
    description:
      "A custom, GPT-style Transformer architecture built from scratch in PyTorch and Python. Implements standard GPT-2 tokenization, embeddings, multi-head self-attention networks, causal masking, and autoregressive text generation. Initialized with pre-trained GPT-2 weight mapping to allow functional localized text output execution.",
    tags: [
      "PyTorch",
      "Transformers",
      "LLM",
  ...
  },
  {
    ...
    description:
      "A collaborative, infinite design canvas featuring high-performance hybrid rendering (HTML5 Canvas element + responsive DOM layout). Supports advanced graph-based logic node connections, collaborative cursor synchronizations, offline-first persistence using IndexedDB, and high FPS pan-and-zoom actions.",
    tags: [
      "HTML5 Canvas",
      "JavaScript",
      "IndexedDB",
      ...
      >
        ...
        <div
          style={{
            ...
            height: "80%",
            background:
              "radial-gradient(circle, rgba(0, 240, 255, 0.03) 0%, rgba(139, 92, 246, 0.02) 50%, rgba(0,0,0,0) 100%)",
            pointerEvents: "none",
            zIndex: 1,
          }}
        />
              ...
              >
                ...
                {activeStage === 6 && (
                  ...
                  >
                    ...
                    >
                      <CornerRightDown size={14} /> Click project in 3D scene to
                      open
                    </div>
        ...
        >
          ...
          <div
            style={{
              ...
              background:
                "linear-gradient(to bottom, #a855f7, var(--accent-color))",
              borderRadius: "2px",
          ...
          {STAGES_DATA.map((stg, idx) => (
            <div
              ...
              style={{
                ...
                boxShadow:
                  activeStage === idx ? "0 0 8px var(--accent-color)" : "none",
                zIndex: 11,
                cursor: "pointer",
              ...
              onClick={() => {
                ...
                if (containerRef.current) {
                  ...
                  const absoluteTop =
                    window.scrollY + rect.top + stageFraction * totalHeight;
