...
const SceneWrapper = ({ scrollProgress, activeStage, hoveredProject, setHoveredProject, onProjectClick }) => {
  const { size } = useThree();
  ...
  return (
    <group scale={[scale, scale, scale]}>
      ...
      <JourneyLabels activeStage={activeStage} hoveredProject={hoveredProject} />
    </group>
  );
};

const AIJourneyCanvas = ({ scrollProgress, activeStage, hoveredProject, setHoveredProject, onProjectClick }) => {
  return (
