...
export default function ProjectsPage() {
  ...
  const handleOpenProject = (project) => {
    ...
    if (
      ...
      project.documentation.sections.length > 0
    ) {
  ...
  const renderSectionContent = (section) => {
    ...
    if (section.subtabs && section.subtabs.length > 0) {
      const activeSub =
        section.subtabs.find((st) => st.id === activeArchSubTab) ||
        section.subtabs[0];
      return (
        <div
  ...
  const activeSection = selectedProject?.documentation?.sections?.find(
    (s) => s.id === activeMainTab,
  );
  ...
  return (
    <section
      ...
      style={{ paddingTop: "8rem", minHeight: "90vh" }}
    >
      {!selectedProjectId ? (
        <>
          ...
          >
            <div
              style={{
                ...
                height: "4px",
                background:
                  "linear-gradient(90deg, var(--accent-color), #2563eb)",
              }}
            />
            <h2
              style={{
            ...
            >
              A collection of architectural designs, deep learning
              implementations, and frontend interfaces. Deep dive into the
              source files, design documents, and operational components of each
              system.
            </p>
          </div>
